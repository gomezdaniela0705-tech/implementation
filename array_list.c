...
//Cada que se llene la lista , esta va a crecer, pero no sumandole su cantidad por defectos
//Sino que va creciendo linealmente segun las necesidades
#define GROWTH_FACTOR 2 

ArrayList* array_create(int initial_capacity, int element_size){
	//El desarrollo puede escoger una necesidad inicial custom, pero si no la defien
	//Se va con capacidad minima por defecto
