...
void arraylist_insert(ArrayList *list, void *element,int index);//Agrega un elemnto en la posición
...
void arraylist_trim_to_size(ArrayList *list);//Ajusta el tamaño dinamico al usuariompor los elementos
